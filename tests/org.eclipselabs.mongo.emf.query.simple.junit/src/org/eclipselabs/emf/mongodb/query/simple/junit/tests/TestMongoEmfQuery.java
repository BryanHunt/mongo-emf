...
package org.eclipselabs.emf.mongodb.query.simple.junit.tests;
...
import org.eclipselabs.emf.mongodb.query.simple.junit.model.Library;
import org.eclipselabs.emf.mongodb.query.simple.junit.model.ModelPackage;
import org.eclipselabs.emf.mongodb.query.simple.junit.model.Person;
...
public class TestMongoEmfQuery extends TestHarness
{
	...
	public void testQueryIDAttribute() throws IOException
	{
		...
		PrimaryObject primaryObject = org.eclipselabs.emf.mongodb.junit.model.ModelFactory.eINSTANCE.createPrimaryObject();
		...
		ResourceSet resourceSet = createResourceSet();
		Resource resource = resourceSet.getResource(createQueryURI(org.eclipselabs.emf.mongodb.junit.model.ModelPackage.Literals.PRIMARY_OBJECT, "idAttribute=='" + id + "'"), true);
		assertThat(resource, is(notNullValue()));
		assertThat(resource.getContents().size(), is(1));
	...
	{
		ETypes eTypes = org.eclipselabs.emf.mongodb.junit.model.ModelFactory.eINSTANCE.createETypes();
		eTypes.setELong(1);

		ResourceSet resourceSet = createResourceSet();
		Resource resource = resourceSet.createResource(createCollectionURI(org.eclipselabs.emf.mongodb.junit.model.ModelPackage.Literals.ETYPES));
		resource.getContents().add(eTypes);
		HashMap<String, Object> options = new HashMap<String, Object>(1);
		options.put(Options.OPTION_SERIALIZE_DEFAULT_ATTRIBUTE_VALUES, Boolean.TRUE);
		resource.save(options);

		eTypes = org.eclipselabs.emf.mongodb.junit.model.ModelFactory.eINSTANCE.createETypes();
		eTypes.setEInt(1);

		resource = resourceSet.createResource(createCollectionURI(org.eclipselabs.emf.mongodb.junit.model.ModelPackage.Literals.ETYPES));
		resource.getContents().add(eTypes);
		resource.save(null);

		resourceSet = createResourceSet();
		resource = resourceSet.getResource(createQueryURI(org.eclipselabs.emf.mongodb.junit.model.ModelPackage.Literals.ETYPES, "eInt == 0"), true);
		ECollection eCollection = (ECollection) resource.getContents().get(0);
		assertThat(eCollection.getValues().size(), is(1));
	...
	public void testQueryDate() throws IOException
	{
		...
		resource = resourceSet.getResource(
				createQueryURI(org.eclipselabs.emf.mongodb.junit.model.ModelPackage.Literals.ETYPES, "eDate >= " + EcoreFactory.eINSTANCE.convertToString(EcorePackage.Literals.EDATE, new Date())), true);
		ECollection eCollection = (ECollection) resource.getContents().get(0);
		assertThat(eCollection.getValues().size(), is(1));
	}
	...
	public void testQueryWithInvalidOperator() throws IOException
	{
		...
		TargetObject targetObject = org.eclipselabs.emf.mongodb.junit.model.ModelFactory.eINSTANCE.createTargetObject();
