...
public class MongoCursor extends MinimalEObjectImpl.Container implements EObject, Iterable<EObject>
{
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipselabs.mongoemf.model.MongoCursor%> _this = this;\n<%org.eclipselabs.mongoemf.model.MongoCursor%> _this_1 = this;\n<%org.eclipselabs.mongoemf.model.MongoCursor%> _this_2 = this;\n<%org.eclipse.emf.ecore.resource.Resource%> _eResource = _this_2.eResource();\n<%org.eclipselabs.mongoemf.model.MongoCursor%> _this_3 = this;\n<%org.eclipselabs.mongoemf.util.MongoIterator%> _mongoIterator = new <%org.eclipselabs.mongoemf.util.MongoIterator%>(_this.dbCursor, _this_1.dbCollection, _eResource, _this_3.objectBuilder);\nreturn _mongoIterator;'"
   * @generated
   */
