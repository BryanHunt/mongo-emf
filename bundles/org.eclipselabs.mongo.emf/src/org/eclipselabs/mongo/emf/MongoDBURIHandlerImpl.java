...
public class MongoDBURIHandlerImpl extends URIHandlerImpl
{
	...
	public OutputStream createOutputStream(final URI uri, final Map<?, ?> options) throws IOException
	{
		...
		return new MongoDBOutputStream(converterService, collection, uri, options, getResponse(options));
	}
	...
	{
		DBCollection collection = getCollection(uri, options);
		return new MongoDBInputStream(converterService, queryEngine, collection, uri, options, getResponse(options));
	}
