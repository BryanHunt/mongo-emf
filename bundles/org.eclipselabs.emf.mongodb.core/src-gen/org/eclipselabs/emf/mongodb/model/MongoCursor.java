 ...
 * @model kind="class" superTypes="org.eclipselabs.emf.mongodb.model.Iterable"
 * @generated
 */
public class MongoCursor extends MinimalEObjectImpl.Container implements EObject, Iterable<EObject>
{
   ...
   * @model unique="false" dataType="org.eclipselabs.emf.mongodb.model.DBCursor"
   * @generated
   */
   ...
   * @model unique="false" dataType="org.eclipselabs.emf.mongodb.model.DBCollection"
   * @generated
   */
   ...
   * @model unique="false" dataType="org.eclipselabs.emf.mongodb.model.EObjectBuilder"
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @model dataType="org.eclipselabs.emf.mongodb.model.Iterator" unique="false"
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipselabs.emf.mongodb.model.MongoCursor%> _this = this;\n<%org.eclipselabs.emf.mongodb.model.MongoCursor%> _this_1 = this;\n<%org.eclipselabs.emf.mongodb.model.MongoCursor%> _this_2 = this;\n<%org.eclipse.emf.ecore.resource.Resource%> _eResource = _this_2.eResource();\n<%org.eclipselabs.emf.mongodb.model.MongoCursor%> _this_3 = this;\n<%org.eclipselabs.emf.mongodb.util.MongoIterator%> _mongoIterator = new <%org.eclipselabs.emf.mongodb.util.MongoIterator%>(_this.dbCursor, _this_1.dbCollection, _eResource, _this_3.objectBuilder);\nreturn _mongoIterator;'"
   * @generated
   */
  public Iterator<EObject> iterator()
  {
    MongoCursor _this = this;
    MongoCursor _this_1 = this;
    MongoCursor _this_2 = this;
    Resource _eResource = _this_2.eResource();
    MongoCursor _this_3 = this;
    MongoIterator _mongoIterator = new MongoIterator(_this.dbCursor, _this_1.dbCollection, _eResource, _this_3.objectBuilder);
    return _mongoIterator;
  }
